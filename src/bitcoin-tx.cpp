...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dotcoin Core Dotcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Dotcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Dotcoin transaction") + "\n" +
              "  Dotcoin-tx [options] -create [commands]   " + _("Create hex-encoded Dotcoin transaction") + "\n" +
              "\n";
