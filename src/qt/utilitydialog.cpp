    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dotcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dotcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dotcoin Core is shutting down...") + "<br /><br />" +
