...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Dotcoin address (e.g. %1)").arg("Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2"));
#endif
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("Dotcoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "Dotcoin:");
    }
...
{
    QString ret = QString("Dotcoin:%1").arg(info.address);
    int paramCount = 0;
